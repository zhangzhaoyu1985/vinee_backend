  ...
  while($p1 < count($score_array) && $p2 < count($review_array)) {
    ...
    if ($score['timeStamp'] > $review['timeStamp']) {
      ...
      if($sql->num_rows > 0) {
        ...
        $data->sex = ($row['sex'] == 'm' ? Services\WineMateServices\ReviewerSex::MALE : Services\WineMateServices\ReviewerSex::FEMALE);
...
function insert_system_posts($request, $response) {
  if ($request->countryId == Services\WineMateServices\CountryId::ENGLISH) {
    ...
    $data->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data1 = new Services\WineMateServices\NewsFeedData;
    $data1->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data2 = new Services\WineMateServices\NewsFeedData;
    $data2->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data3 = new Services\WineMateServices\NewsFeedData;
    $data3->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data4 = new Services\WineMateServices\NewsFeedData;
    $data4->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data5 = new Services\WineMateServices\NewsFeedData;
    $data5->feedType = Services\WineMateServices\FeedType::SYSTEMFEED;
    ...
    $data5->picUrl = "http://50.18.207.106/pics/newsfeed_contents/NewsFeedChinese_7.png";
...
function getRewardPointsByActionType($action, $wineId) {
  switch($action) {
    case Services\WineMateServices\UserActions::ShareWineInfoToWechat:
      return 1;
    case Services\WineMateServices\UserActions::OpenedBottle:
      return 5;
    case Services\WineMateServices\UserActions::ShareWineryInfoToWechat:
      return 10;
    case Services\WineMateServices\UserActions::ShareWineryMemberShipToWechat:
      return 20;
    default: 
      return 0;
  }
