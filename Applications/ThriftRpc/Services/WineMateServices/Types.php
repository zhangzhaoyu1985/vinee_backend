...
class WineInfo {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 17:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->latitude);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 18:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->longitude);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->latitude !== null) {
      $xfer += $output->writeFieldBegin('latitude', TType::STRING, 17);
      $xfer += $output->writeString($this->latitude);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->longitude !== null) {
      $xfer += $output->writeFieldBegin('longitude', TType::STRING, 18);
...
class BottleOpenInfo {
  ...
  public function write($output) {
    ...
    if ($this->latitude !== null) {
      $xfer += $output->writeFieldBegin('latitude', TType::STRING, 10);
      $xfer += $output->writeString($this->latitude);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->longitude !== null) {
      $xfer += $output->writeFieldBegin('longitude', TType::STRING, 11);
      $xfer += $output->writeString($this->longitude);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class WineBasicInfoResponse {
  ...
  /**
   * @var \Services\WineMateServices\FoodParingPics[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        8 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\FoodParingPics',
            ),
          ),
        9 => array(
          'var' => 'regionName',
      ...
      switch ($fid)
      {
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Services\WineMateServices\FoodParingPics();
...
class WineReviewAndRatingReadResponse {
  ...
  /**
   * @var \Services\WineMateServices\WineReviewAndRatingData[]
   */
  public $data = null;
  /**
   * @var int
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\WineReviewAndRatingData',
            ),
          ),
        2 => array(
          'var' => 'numOfRating',
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Services\WineMateServices\WineReviewAndRatingData();
...
class BottleInfo {
  ...
  public function write($output) {
    ...
    if ($this->latitude !== null) {
      $xfer += $output->writeFieldBegin('latitude', TType::STRING, 13);
      $xfer += $output->writeString($this->latitude);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->longitude !== null) {
      $xfer += $output->writeFieldBegin('longitude', TType::STRING, 14);
      $xfer += $output->writeString($this->longitude);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class OpenedBottlesResponse {
  ...
  public $sex = null;
  /**
   * @var \Services\WineMateServices\BottleInfo
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        7 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\Services\WineMateServices\BottleInfo',
          ),
        8 => array(
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::STRUCT) {
            $this->currentOpenedBottleInfo = new \Services\WineMateServices\BottleInfo();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Services\WineMateServices\BottleInfo();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \Services\WineMateServices\BottleInfo();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem33 = null;
              $elem33 = new \Services\WineMateServices\BottleInfo();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new \Services\WineMateServices\BottleInfo();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 10:
          if ($ftype == TType::STRUCT) {
            $this->bottleInfo = new \Services\WineMateServices\BottleInfo();
...
class NewsFeedResponse {
  ...
  /**
   * @var \Services\WineMateServices\NewsFeedData[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\NewsFeedData',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem47 = null;
              $elem47 = new \Services\WineMateServices\NewsFeedData();
...
class WineryInfoResponse {
  ...
  /**
   * @var \Services\WineMateServices\WineryInfoResponseSingleItem[]
   */
  public $wineryWineList = null;
  /**
   * @var \Services\WineMateServices\WineryInfoSingleContent[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\WineryInfoResponseSingleItem',
            ),
          ),
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\WineryInfoSingleContent',
            ),
          ),
        3 => array(
          'var' => 'wineryPhotoUrls',
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem54 = null;
              $elem54 = new \Services\WineMateServices\WineryInfoResponseSingleItem();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem60 = null;
              $elem60 = new \Services\WineMateServices\WineryInfoSingleContent();
...
class FriendListResponse {
  ...
  /**
   * @var \Services\WineMateServices\FriendInfo[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\FriendInfo',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem75 = null;
              $elem75 = new \Services\WineMateServices\FriendInfo();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem82 = null;
              $elem82 = new \Services\WineMateServices\FriendInfo();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem89 = null;
              $elem89 = new \Services\WineMateServices\FriendInfo();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem96 = null;
              $elem96 = new \Services\WineMateServices\BottleInfo();
...
class RewardItemResponse {
  ...
  /**
   * @var \Services\WineMateServices\RewardSingleItem[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\RewardSingleItem',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem103 = null;
              $elem103 = new \Services\WineMateServices\RewardSingleItem();
...
class RewardRedeemRequest {
  ...
  public $userId = null;
  /**
   * @var \Services\WineMateServices\RewardRedeemSingleItem[]
   */
  public $RewardRedeemItems = null;
  /**
   * @var \Services\WineMateServices\Address
   */
  public $address = null;
  /**
   * @var string
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Services\WineMateServices\RewardRedeemSingleItem',
            ),
          ),
        3 => array(
          'var' => 'address',
          'type' => TType::STRUCT,
          'class' => '\Services\WineMateServices\Address',
          ),
        4 => array(
          'var' => 'trackingNumber',
          'type' => TType::STRING,
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem110 = null;
              $elem110 = new \Services\WineMateServices\RewardRedeemSingleItem();
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->address = new \Services\WineMateServices\Address();
